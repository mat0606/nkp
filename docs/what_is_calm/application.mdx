...
2.  Click on **Hamburger Menu**.  Select **Apps and Marketplace**

    ![](images/AppSwitcher-Apps.png)
...
3.  Click on Group by **Project**

    ![](images/MyApp-2.png)

4.  Look at the list of application group by Project
